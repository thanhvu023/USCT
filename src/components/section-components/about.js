                        ...
                        <div className="col-lg-6">
                          <div className="about-inner-wrap pl-xl-4 pt-5 pt-lg-0 mt-5 mt-lg-0">  
                            <div className="section-title mb-0">
                              ...
                              <p className="content">Chúng tôi cung cấp dữ liệu đầy đủ và chính xác nhất để hỗ trợ quyết định du học của bạn. Sự lựa chọn du học Mỹ nay trở nên dễ dàng và minh bạch hơn bao giờ hết.</p>
                                ...
                                <li className="single-list-inner style-check-box-grid">
                                  <div className="media">
                                    ...
                                    <div className="media-body">
                                      ...
                                      <p>Chúng tôi cung cấp thông tin chi tiết và tư vấn chọn trường, chương trình học để phù hợp với mục tiêu và năng lực của bạn.</p>
                                    </div>
                                  </div>
                                </li>
                                <li className="single-list-inner style-check-box-grid">
                                  <div className="media">
                                    ...
                                    <div className="media-body">
                                      ...
                                      <p>Chúng tôi hỗ trợ bạn trên mỗi bước đi của quá trình ứng tuyển, từ việc chuẩn bị hồ sơ đến lựa chọn học bổng phù hợp.</p>
                                    </div>
                                  </div>
                                </li>
                              </ul>
