          ...
          <div className="about-area-inner">
            <div className="row">
              <div className="col-lg-6 col-md-10">
                <div
                  className="about-thumb-wrap style-two"
                  style={{
                    backgroundImage:
                      'url("' + publicUrl + 'assets/img/about/3.png")',
                  }}
                ></div>
              </div>
                    ...
                    <ul className="single-list-wrap">
                      <li className="single-list-inner style-box-2">
                        <div className="media">
                          <div className="media-left">
                            <img
                              src={publicUrl + "assets/img/icon/23.png"}
                              alt="img"
                            />
                          </div>
                          <div className="media-body align-self-center">
                            ...
                            <p>
                              ...
                              elitr, sed diam nonumy eirmod tempor invidun
                            </p>
                          </div>
                        </div>
                      </li>
                      <li className="single-list-inner style-box-2">
                        <div className="media">
                          <div className="media-left">
                            <img
                              src={publicUrl + "assets/img/icon/24.png"}
                              alt="img"
                            />
                          </div>
                          <div className="media-body align-self-center">
