  ...
  const groupsMajor = [
    {
      ...
      name: "Group 1",
      imageUrl:
        "https://i.pinimg.com/564x/57/d7/45/57d745474a39ccc097deb6813aa9d362.jpg",
    },
    {
      id: 2,
      name: "Group 2",
          ...
          <div className="col-lg-8">
            <div className="blog-details-page-content">
              ...
              <div className="majors">
                <h1>Group Majors</h1>
                <h3>
                  Information about specific majors and outstanding training
                  schools - helping you save time searching for majors of
                  interest
                </h3>
